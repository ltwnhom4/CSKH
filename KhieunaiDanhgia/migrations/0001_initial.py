...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('LichHen', '0002_lichhen_nguoi_tao'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lich_hen', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='danh_gia', to='LichHen.lichhen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lich_hen', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='khieu_nai', to='LichHen.lichhen')),
                ('nguoi_gui', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('nhan_vien_phu_trach', models.ForeignKey(blank=True, limit_choices_to={'is_staff': True}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='khieunai_phu_trach', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
